...
class m200130_194447_create_order_table extends Migration {
    ...
    public function safeUp() {
        ...
        $this->createTable('{{%order}}', [
            ...
            'total_price' => $this->float()->unsigned()->defaultValue(0),
            'total_items_price' => $this->float()->unsigned()->defaultValue(0),
            'delivery_fee' => $this->float()->unsigned()->defaultValue(0),
            'order_status' => $this->tinyInteger(1)->unsigned()->defaultValue(1),
            'order_mode' => $this->tinyInteger(1)->unsigned()->notNull(),
