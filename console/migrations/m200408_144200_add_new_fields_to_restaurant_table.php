...
class m200408_144200_add_new_fields_to_restaurant_table extends Migration {
    ...
    public function safeUp() {
        $this->addColumn('restaurant', 'business_id', $this->string()->notNull());
        $this->addColumn('restaurant', 'business_entity_id', $this->string()->notNull());
        $this->addColumn('restaurant', 'wallet_id', $this->string()->notNull());
        $this->addColumn('restaurant', 'merchant_id', $this->string()->notNull());
        $this->addColumn('restaurant', 'operator_id', $this->string()->notNull());

        $this->dropColumn('restaurant', 'restaurant_api_key');
        $this->addColumn('restaurant', 'live_api_key', $this->string());
        $this->addColumn('restaurant', 'test_api_key', $this->string()->notNull());
    ...
    public function safeDown() {
        $this->dropColumn('restaurant', 'business_id');
        $this->dropColumn('restaurant', 'business_entity_id');
        $this->dropColumn('restaurant', 'wallet_id');
        $this->dropColumn('restaurant', 'merchant_id');
        $this->dropColumn('restaurant', 'operator_id');
        $this->addColumn('restaurant', 'restaurant_api_key', $this->string()->after('phone_number'));
        $this->dropColumn('restaurant', 'live_api_key');
        $this->dropColumn('restaurant', 'test_api_key');
