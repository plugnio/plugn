...
class CronController extends \yii\console\Controller {
    ...
    public function actionTest() {
        ...
        $store_model = Restaurant::find()->one();

        $this->stdout("Enterning getLastCommitResponse  \n", Console::FG_RED, Console::BOLD);
...
//Replace test with store branch name
            ...
            $this->stdout("Enterning createBranchResponse  \n", Console::FG_RED, Console::BOLD);
...
//Replace test with store branch name
                $this->stdout("Enterning commitBuildJsFileResponse  \n", Console::FG_RED, Console::BOLD);
...
//Replace test with store domain name
                    $this->stdout("Enterning createNewSiteResponse  \n", Console::FG_RED, Console::BOLD);
                    $createNewSiteResponse = Yii::$app->netlifyComponent->createSite('juiced.plugn.store');

                    if ($createNewSiteResponse->isOk) {

                        $site_id = $createNewSiteResponse->data['site_id'];
//will save site id to deploy
                        $this->stdout("Enterning deploySiteResponse  \n", Console::FG_RED, Console::BOLD);
