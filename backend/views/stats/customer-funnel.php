...
<div class="site-index">
    <div class="body-content">
        ...
        <div class="grid">
            ...
            <?= Html::beginForm(['/stats/customer-funnel'], 'GET', ['class' => "form-inline form-filter"]); ?>
                ...
                <div class="col-xl-3 col-lg-4">
                    ...
                    <div class="card card-stats mb-4 mb-xl-0">
                        <div class="card-body">
                            ...
                            <h5 class="card-title text-uppercase text-muted mb-0">No of Orders Placed</h5>
                ...
                <div class="col-xl-3 col-lg-4">
                    ...
                    <div class="card card-stats mb-4 mb-xl-0">
                        <div class="card-body">
                            ...
                            <h5 class="card-title text-uppercase text-muted mb-0">No of Orders Completed</h5>
                            <span class="h2 font-weight-bold mb-0"><?= $completedOrders ?></span>
