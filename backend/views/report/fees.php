...
$this->title = 'Plugn commission report';
...
<div class="site-index">
    <div class="body-content">
        ...
        <div class="grid">
            ...
            <h3>Plugn commission report</h3>

            <br />

            <div class="panel panel-default">
                <div class="panel-heading">
                    <span class="title">Download commission report</span>
                </div>

                <div class="panel-body">

                    <?= Html::beginForm(['/report/download'], 'GET', ['class' => "form form-filter"]); ?>
