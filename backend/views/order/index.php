    ...
    <?php if ($count > 0) { ?>
        ...
        <div class="action-btns ">
            <div class="btn-dropdown mr-1 mb-1">
                ...
                <div class="btn-group dropdown actions-dropodown">
                    <?= Html::a('Print Pending Orders For Mashkor', ['download-pending-orders-for-mashkor'], ['class' => 'btn btn-success']) ?>
                </div>
            </div>
        </div>
-->
                ...
                'columns' => [
                    ...
                    [
                        ...
                        "value" => function($model) {
                            return Html::a('#' . $model->order_uuid, ['order/view', 'id' => $model->order_uuid]);
                        }
                    ],
                    [
                    ...
                    [
                        ...
                        'value' => function ($data) {
                            if ($data->customer_id)
                                return Html::a($data->customer_name, ['customer/view', 'id' => $data->customer_id]);
                            else
