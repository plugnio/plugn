...
class RestaurantController extends Controller {
    ...
    public function actionCreateBuildJsFile($id) {
        ...
        if (!file_exists( $dirName . "/" . $restaurant->store_branch_name )) {
          $myFolder = mkdir( $dirName . "/" . $restaurant->store_branch_name);
        }


        $myfile =  fopen($dirName . "/" .   $restaurant->store_branch_name . "/build.js", "w") or die("Unable to open file!");
