...
class PaymentSearch extends Payment
{
    ...
    {
        return [
            [['payment_uuid', 'store_name', 'customer_name','restaurant_uuid', 'order_uuid', 'payment_gateway_order_id', 'payment_gateway_transaction_id', 'payment_gateway_payment_id', 'payment_gateway_invoice_id', 'payment_mode', 'payment_current_status', 'payment_udf1', 'payment_udf2', 'payment_udf3', 'payment_udf4', 'payment_udf5', 'payment_created_at', 'payment_updated_at', 'response_message', 'payment_token', 'payment_gateway_name'], 'safe'],
