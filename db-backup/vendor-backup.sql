...
(450, 'rest_00f54a5e-7c35-11ea-997e-4a682ca4b290', 'Special Offer', 'عرض خاص', 1),
(451, 'rest_00f54a5e-7c35-11ea-997e-4a682ca4b290', ' Fresh Fruit Chunks ', 'قطع الفواكه طازج ', 1),
(452, 'rest_00f54a5e-7c35-11ea-997e-4a682ca4b290', ' Cold Pressed (Detox Juices) ', ' عصائر باردة مضغوطة (ديتوكس) ', 3);
...
INSERT INTO `customer` (`customer_id`, `restaurant_uuid`, `customer_name`, `customer_phone_number`, `customer_email`, `customer_created_at`, `customer_updated_at`) VALUES
(4, 'rest_00f54a5e-7c35-11ea-997e-4a682ca4b290', 'sa', '12345678', NULL, '2020-04-12 21:13:13', '2020-04-12 21:13:13');
...
(96517, 99621, 'Carrot Juice', 'عصير جزر', 0),
(96518, 99621, 'Kiwi Fruit Juice', 'عصير كيوي', 0),
(96519, 99621, 'Lemon With Mint Juice', 'عصير ليمون بالنعناع', 0),
(96520, 99622, 'Family Glass 500 ML', 'جلاس العائلي 500 مل', 3),
(96521, 99622, '1000 ML', '1000 مل', 4.5),
(96522, 99622, '500 ML', '500 مل', 2.5),
(96523, 99622, '1000 ml Glass', '1000 مل (زجاج)', 5),
(96524, 99623, 'Family Glass 500 ML', 'جلاس العائلي 500 مل', 3),
(96525, 99623, '1000 ml', '1000 مل', 4.5);
...
('m200411_113002_create_restaurant_theme_table', 1586617991),
('m200412_111439_add_restaurant_domain_field_to_restaurant_table', 1586691494);
...
(99621, 'item_90e24876-7c3d-11ea-997e-4a682ca4b290', 1, 5, 'Your choice of Juices - Any 5', 'اختار اي خمس من العصائر'),
(99622, 'item_b6f27224-7c3e-11ea-997e-4a682ca4b290', 1, 1, 'Your Choice Of', 'أختيارك من'),
(99623, 'item_404f9768-7c3f-11ea-997e-4a682ca4b290', 1, 1, 'Your Choice Of', 'اختيارك من');
...
('rest_00f54a5e-7c35-11ea-997e-4a682ca4b290', 1),
('rest_c2af4218-6b72-11ea-bfa2-270399f50534', 1),
('rest_00f54a5e-7c35-11ea-997e-4a682ca4b290', 2),
('rest_00f54a5e-7c35-11ea-997e-4a682ca4b290', 3),
...
--
ALTER TABLE `category`
  MODIFY `category_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=453;
...
--
ALTER TABLE `extra_option`
  MODIFY `extra_option_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=96526;

--
-- AUTO_INCREMENT for table `option`
--
ALTER TABLE `option`
  MODIFY `option_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=99624;
