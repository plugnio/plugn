...
/* @var $invoice common\models\RestaurantInvoice */
?>
                                        ...
                                        >
                                            ...
                                            <tr>
                                                ...
                                                >
                                                    ...
                                                    >
                                                        Invoice #<?= $invoice->invoice_number ?> now available to pay.
                                                    </div>
                                            ...
                                            <tr>
                                                ...
                                                >
                                                    ...
                                                    <div
                                                        style="font-family:Proxima Nova, Arial, Arial, Helvetica, sans-serif;font-size:15px;line-height:24px;text-align:left;color:#000000;"
                                                    >
                                                        Invoice for Plugn commission is available to pay, please check and let us know if any query.
                                                    </div>
                                            ...
                                            <tr>
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <tr>
                                                            <td
                                                                    align="center" bgcolor="#000000" role="presentation" style="border:1px solid black;border-radius:5px;cursor:auto;padding:10px 25px;background:#000000;" valign="middle"
                                                            >
                                                                <a href="https://dash.plugn.io/invoice-view/<?= $invoice->invoice_uuid ?>" style="background:#000000;color:#ffffff;font-family:Proxima Nova, Arial, Arial, Helvetica, sans-serif;font-size:15px;font-weight:bold;line-height:120%;Margin:0;text-decoration:none;text-transform:none;" target="_blank"
                                                                >
                                                                    View Invoice
                                                                </a>
                                                            </td>
                                                            ...
                                                            >
                                                                <a
                                                                    href="mailto:contact@plugn.io?subject=Invoice #<?= $invoice->invoice_number ?>&body=I would like to talk to customer support for assistance." style="background:#ffffff;color:#000000;font-family:Proxima Nova, Arial, Arial, Helvetica, sans-serif;font-size:15px;font-weight:bold;line-height:120%;Margin:0;text-decoration:none;text-transform:none;" target="_blank"
                                                                >
                                                                    Let's talk
                                                                </a>
                                                            </td>
