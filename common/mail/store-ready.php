...
$customDomainUrl = Yii::$app->params['frontendUrl'] . '/site/domains?id=' . $store->restaurant_uuid;
    ...
    @media only screen and (max-width:480px) {
      ...
      >
        Your store <?= $store->name ?> is now ready for use
            ...
            <tr>
              <td
                 align="center" style="font-size:0px;padding:10px 25px;padding-top:25px;padding-bottom:3px;word-break:break-word;"
              >
      ...
      <div
         style="font-family:Proxima Nova, Arial, Arial, Helvetica, sans-serif;font-size:21px;line-height:24px;text-align:center;color:#000000;"
      >
      ...
      >
        <tr>
          ...
          >
            <a
               href="<?= $store_domain ?>" style="background:#ffffff;color:#000000;font-family:Proxima Nova, Arial, Arial, Helvetica, sans-serif;font-size:15px;font-weight:bold;line-height:120%;Margin:0;text-decoration:none;text-transform:none;" target="_blank"
            >
              Visit Website
            </a>
          </td>
      ...
      <div
         style="font-family:Proxima Nova, Arial, Arial, Helvetica, sans-serif;font-size:15px;line-height:24px;text-align:center;color:#000000;"
      >
        You are also able to replace the above url with your own <a href="<?= $customDomainUrl ?>"><u>custom domain</u></a>
      </div>
