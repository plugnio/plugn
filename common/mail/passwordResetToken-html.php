...
.mj-column-per-33 { width:33.333333333333336% !important; max-width: 33.333333333333336%; }
    ...
    <!--[if mso | IE]>
      ...
      <div
         style="font-family:Proxima Nova, Arial, Arial, Helvetica, sans-serif;font-size:14px;line-height:24px;text-align:left;color:#000000;"
      >
      Somebody (hopefully you) requested a new password for the Plugn account for <?= $agent->agent_email ?>. No changes have been made to your account yet.
      </div>
            ...
            <tr>
              ...
              >
                ...
                >
                  <tr>
                  <td
                     align="center" bgcolor="#2B546A" role="presentation" style="border:none;border-radius:5px;cursor:auto;padding:10px 25px;background:#2B546A;"
                  >
                    <a
                       href="<?= $resetLink ?>" style="background:#2B546A;color:#ffffff;font-family:Proxima Nova, Arial, Arial, Helvetica, sans-serif;font-size:14px;font-weight:bold;line-height:120%;Margin:0;text-decoration:none;text-transform:none;" target="_blank"
                    >
                      Change my password
                    </a>
                  </td>
            ...
            <tr>
              ...
              >
                ...
                >
                  <tr>
                  <td
                     align="center"  role="presentation" style="border:none;border-radius:5px;cursor:auto;padding:10px 25px;"
                  >
                  <div
                  style="font-family:Proxima Nova, Arial, Arial, Helvetica, sans-serif;font-size:14px;line-height:24px;text-align:left;color:#000000;"
                  >
      ...
      >
        <b>Button not working?</b> Copy and paste this link into your browser: <br/>
        <?=
          Html::a($resetLink, $resetLink , ['style' => 'text-decoration: none; color:#2B546A;' ,'target' => '_blank'])
        ?>
      </div>
