...
class AddonPayment extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            'payment_uuid' => Yii::t('common', 'Payment Uuid'),
            'restaurant_uuid' => Yii::t('common', 'Restaurant Uuid'),
            'addon_uuid' => Yii::t('common', 'Addon Uuid'),
            'payment_gateway_order_id' => Yii::t('common', 'Payment Gateway Order ID'),
            'payment_gateway_transaction_id' => Yii::t('common', 'Payment Gateway Transaction ID'),
            'payment_mode' => Yii::t('common', 'Payment Mode'),
            'payment_current_status' => Yii::t('common', 'Payment Current Status'),
            'payment_amount_charged' => Yii::t('common', 'Payment Amount Charged'),
            'payment_net_amount' => Yii::t('common', 'Payment Net Amount'),
            'payment_gateway_fee' => Yii::t('common', 'Payment Gateway Fee'),
            'payment_udf1' => Yii::t('common', 'Payment Udf1'),
            'payment_udf2' => Yii::t('common', 'Payment Udf2'),
            'payment_udf3' => Yii::t('common', 'Payment Udf3'),
            'payment_udf4' => Yii::t('common', 'Payment Udf4'),
            'payment_udf5' => Yii::t('common', 'Payment Udf5'),
