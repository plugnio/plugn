...
class Order extends \yii\db\ActiveRecord {
    ...
    public function afterSave($insert, $changedAttributes) {
      ...
      if (!$insert && !$this->sms_sent && isset($changedAttributes['order_status']) && $changedAttributes['order_status'] == self::STATUS_PENDING && $this->order_status == self::STATUS_ACCEPTED) {
