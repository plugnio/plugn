...
`;
     ...
     */
    public function createSitemapXml($storeUuid)
    {
        $client = new Client();
        $apiEndpoint = Yii::$app->params['apiEndpoint'] . '/v2/sitemap/' . $storeUuid;
        ...
        if($response->isOk){
          ...
          Yii::error('Error while creating sitemap.xml -> ' . $storeUuid);
          return false;
        }
    }
}
