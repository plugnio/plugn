...
class TapPayments extends Component
{
     ...
     */
    public function createCharge($currency, $desc = "Pay", $statementDesc = "", $ref, $amount ,$firstName, $email, $country_code ,$phone,$platform_fee, $redirectUrl, $gateway, $warehouse_fee,$warehouse_delivery_charges, $country_name = null)
    {
