...
<script type = "text/javascript">
    ...
    function enableSoundForNewOrders() {
        document.getElementById("new-order-btn").value = true;
    }
    ...
    async function CheckPendingOrders() {
        ...
        fetch(url)
            ...
            .then(data => {
                ...
                if (data && document.getElementById("new-order-btn").value) {
                    console.log('play');
                     soundForNewOrders.play();
                } else if (!data && document.getElementById("new-order-btn").value) {
                    console.log('pause');
                        ...
                        <div class="card">
                            <div class="card-header border-transparent">
                                ...
                                <div class="card-tools">
                                       <?=
                                           Html::button('Play sound for new orders', [ 'class' => 'btn btn-primary','id'=>'new-order-btn', 'onclick' => 'enableSoundForNewOrders()' ]);
                                        ?>
