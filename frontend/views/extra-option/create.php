...
$option = \common\models\Option::findOne($model->option_id);
...
$this->params['breadcrumbs'][] = ['label' => $option->option_name, 'url' => ['option/view', 'id' => $model->option_id, 'storeUuid' => $storeUuid]];
