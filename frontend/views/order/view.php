    ...
    <div style="display: block">
        ...
        if ($model->order_mode == Order::ORDER_MODE_DELIVERY) {
            ...
            if ($model->restaurant->armada_api_key != null && $model->armada_tracking_link == null) {
                ...
                if ($difference <= 1  && $model->restaurant_uuid != 'rest_6a55139f-f340-11ea-808a-0673128d0c9c' && $model->restaurant_uuid != 'rest_5d657108-c91f-11ea-808a-0673128d0c9c'){
                ...
                if ($model->restaurant_uuid == 'rest_6a55139f-f340-11ea-808a-0673128d0c9c' || $model->restaurant_uuid = 'rest_5d657108-c91f-11ea-808a-0673128d0c9c')  {
                      echo Html::a('Request a driver from Armada', ['request-driver-from-armada', 'storeUuid' => $model->restaurant_uuid, 'order_uuid' => $model->order_uuid], [
                          'class' => 'btn btn-dark mr-1 mb-1',
                          'style' => 'margin-right: 7px;',
                          'data' => [
                    ...
                    <?php if ($model->voucher_id != null && $model->voucher_id && $model->voucher->discount_type == Voucher::DISCOUNT_TYPE_FREE_DELIVERY) {
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="float: right;"><?= Yii::$app->formatter->asCurrency(0, '', [NumberFormatter::MIN_FRACTION_DIGITS => 3, NumberFormatter::MAX_FRACTION_DIGITS => 5]) ?></td>
                            </tr>
                        </tbody>
    <?php } ?>
