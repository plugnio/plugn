...
<div class="restaurant-view">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <p style="color: black;">We partnered with My Fatoorah to empower you with competitive fees and shorter settlement windows.</p>
                ...
                <table class="table table-responsive" style="margin-bottom: 20px">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="<?= $model->plan->plan_id == 1  ? (($model->country->iso !=  'BH' && $model->country->iso !=  'SA' && $model->country->iso !=  'KW') ||
                              ( $model->country->iso ==  'SA' && $model->currency->code == 'SAR' && $model->business_type == 'ind' )  ||
                              ( $model->country->iso ==  'BH' && $model->currency->code == 'BHD' && $model->business_type == 'ind' )
                              ? 'current-plan-body-row current-plan-bottom-row' : 'current-plan-body-row') : ''   ?>">
                                5% per transaction, no minimum.
                            </td>
                            <td>
                      ...
                      <tr>
                          <th scope="row">
                            <div style="text-align: center; display:block">
                              ...
                              <img src="<?= Yii::$app->urlManager->getBaseUrl() . '/img/sadad.png' ?>" style=" width: 30px; ">

                            </div>
                            <span style="margin-top:5px;text-align: center; display:block">Sadad</span>
