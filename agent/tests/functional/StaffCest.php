...
class StaffCest
{
    ...
    public function tryToUpdate(FunctionalTester $I) {
        ...
        $I->sendPATCH('v1/staffs/'. $model->assignment_id . '/' .$this->store->restaurant_uuid, [
            'business_location_id' => 1,
            'role' => AgentAssignment::AGENT_ROLE_OWNER,
            'agent_email' => 'demo@localhost.com'
        ]);
    ...
    public function tryToDelete(FunctionalTester $I) {
        ...
        $I->sendDELETE('v1/staffs/'. $model->assignment_id . '/' .$this->store->restaurant_uuid);
        $I->seeResponseCodeIs(HttpCode::OK); // 200
        $I->seeResponseContainsJson([
            "operation" => "success"
        ]);
